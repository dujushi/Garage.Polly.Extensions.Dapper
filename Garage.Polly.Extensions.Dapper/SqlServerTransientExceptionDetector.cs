...
namespace Garage.Polly.Extensions.Dapper
{
    ...
    {
        /// <summary>
        /// Checks if retry with the <see cref="SqlException"/>.
        /// </summary>
        /// <param name="ex">The <see cref="SqlException"/>.</param>
        ...
        /// <summary>
        /// Checks if retry with the <see cref="Win32Exception"/>.
        /// </summary>
        /// <param name="ex">The <see cref="Win32Exception"/>.</param>
        /// <returns>Whether to retry.</returns>
